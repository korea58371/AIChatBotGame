...
- **원칙**:
  ...
  3. **[주인공 보정]**: 주인공은 운명적인 영웅입니다. 죽을 위기에서는 기연을 만나거나, 의외의 조력자가 나타나는 등 '주인공다운 행운'이 따릅니다.
      - **[Crisis Intervention]**: 초반(30턴 이내)에 주인공이 **사망 위기**에 처하면, **반드시** 히로인이나 강력한 조력자가 나타나 구해주어야 합니다. (허무한 죽음 방지)
      - 너무 허무한 죽음(개사)을 지양하고, 성장의 발판을 마련하십시오.
...
- **어조**: 
  ...
  - 이야기는 대사를 통해 충분히 캐릭터들의 성격과 매력이 드러나야 하며, 최소 8000자 이상 서술되어야 합니다.(일반적인 웹소설 분량)
`;
...
3.  **[2단계: 맥락 연결 (Bridge Context)]**
    - **[이전 턴의 마지막]** -> **[현재 상황]** -> **[미래 전개]**를 연결하라.
    - 갑작스러운 전개보다는, 인과관계에 따른 자연스러운 흐름을 만들어라.
