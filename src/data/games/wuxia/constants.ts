...
<선택지1> 검을 뽑아 살수들을 베어버린다. (난이도: 어려움 / 보상: 연화린의 호감도 상승)
<선택지2> 술병을 챙겨 조용히 자리를 뜬다. (보상: 없음 / 연화린 사망 루트)
