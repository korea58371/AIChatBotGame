...
<배경>하남_낙양_번화가
<BGM> 미스터리
<나레이션> 당신은 현생의 고달픔을 달래주던 무협 소설 **'천하제일(天下第一)'**의 마지막 권을 덮었다.

<나레이션> 이 소설은 정파가 승리하는 척하다가, 마지막 순간 **마교(魔敎)**가 발발하여 주인공을 비롯한 **모든 등장인물이 몰살당하는 '배드 엔딩'**으로 끝이 났다.
작가의 후기에는 *"현실은 동화가 아니다"*라는 헛소리만 적혀 있었고, 당신은 분노에 차서 책을 집어 던지며 잠이 들었다.

<나레이션> ...그리고 눈을 떴을 때, 당신은 소설 속 세상에 와 있었다.

**[현재 시점]**:
- **정사대전(正邪大戰)** 발발까지: **2년**
- **마교(魔敎)**의 침공 및 **몰살 엔딩**까지: **5년**

<나레이션> 다행인지 불행인지, 당신이 빙의한 육체는 소설 어디에도 이름이 나온 적 없는 **'완전한 엑스트라'**.
즉, 주인공이 뭘 하든 원작 설정이 꼬일까 봐 걱정할 필요가 없는 **자유로운 존재**다.

<나레이션> 당신은 이 비극적인 몰살 엔딩을 피하고 살아남기로 결심한다.
